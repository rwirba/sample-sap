...
echo "Waiting for java-hello-world service in 'demo' namespace..."
until kubectl get svc java-hello-world -n demo &> /dev/null; do sleep 2; done
...
echo "Access your app via: http://$(curl -s http://checkip.amazonaws.com).nip.io/"
